...
const features = [
  {
    title: "From mobile click to magazine shot in 60 seconds",
    description:
      "Premium lighting, contextual depth, and catalogue-ready crops—one flat phone upload, four luxury placements.",
    icon: (
  ...
  {
    title: "Facebook, Instagram & Google ads — written by AI, optimized for India",
    description:
      "Benefit-led hooks, COD-aware phrasing where it fits, and PDP bullets that sound like your brand—not generic fluff.",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
  ...
  {
    title: "Know your customer's pain point before they do",
    description:
      "Category-aware positioning, urgency triggers, and tonal guardrails so every creative feels built for your ICP.",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
        ...
        >
          {features.map((f) => (
            ...
            >
              ...
              <h3 className="relative mt-5 text-lg font-semibold leading-snug text-white sm:text-xl">
                {f.title}
              </h3>
