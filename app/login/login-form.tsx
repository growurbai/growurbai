...
export function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (err === "config")
      setError("Server configuration error. Check Supabase environment variables.");
  }, [searchParams]);
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-[1.35rem] border border-white/[0.1] bg-white/[0.04] p-8 shadow-glass backdrop-blur-xl sm:p-10">
          ...
          <p className="mt-2 text-center text-sm text-zinc-500">
            Sign in to open Brand Kit Studio
          </p>
          ...
          <form onSubmit={handleEmailLogin} className="mt-8 space-y-5">
            <div>
              <label htmlFor="login-email" className="mb-2 block text-xs font-medium uppercase tracking-wider text-zinc-500">
                Email
              </label>
              <input
                id="login-email"
            ...
            <div>
              <label htmlFor="login-password" className="mb-2 block text-xs font-medium uppercase tracking-wider text-zinc-500">
                Password
              </label>
              <input
                id="login-password"
          ...
          <p className="mt-8 text-center text-sm text-zinc-500">
            ...
            <Link href="/signup" className="font-medium text-electric hover:text-gold hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
